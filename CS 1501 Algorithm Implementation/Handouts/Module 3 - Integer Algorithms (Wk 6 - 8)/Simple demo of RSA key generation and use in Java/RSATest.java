...
public class RSATest
{
	...
	{	
		// Example from Slide 191 in lecture notes
		...
		BigInteger D1 = new BigInteger("13");
		BigInteger D2 = new BigInteger("73");  	// add PHI
		BigInteger D3 = new BigInteger("133");	// add PHI again
