...
guess:
    ...
    lb      $t0, ($s0)   # Load current cell's value in $t0
...
guess_loop:
    ...
    sb      $s3, ($s0)   # If OK, assign number to cell
...
guess_chk_failed:
    ...
    sb      $zero, ($s0) # If no number worked, empty the cell
...
check_row:
    lb      $t2, ($t1)   # Value in the current cell
...
check_col:
    lb      $t2, ($t1)   # Value of the current cell
